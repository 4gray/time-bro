  ...
  WeekView: (props: Record<string, unknown>) => {
    ...
    return (
      ...
      >
        ...
        <button
          type="button"
          onClick={() => (props.onDockLog as (payload: Record<string, unknown>) => void)({ issueKey: "YLOG-101" })}
        >
          dock
        </button>
        <button
...
describe("AppWeekRoute", () => {
  ...
  it("passes WeekView actions through unchanged", () => {
    ...
    expect(handleAddWorklog).toHaveBeenCalledWith({ issueKey: "YLOG-101" });
