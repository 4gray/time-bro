...
export const COMMAND_PALETTE_PLACEHOLDER = "Log 2h on YLOG-352, go to week 28…";
 ...
 * one. The design brief calls for natural-language input — "Log 2h on YLOG-352",
 * "go to week 28" — which is not implemented yet.
 *
 * TODO(nl-parsing): parse free-text time logging ("Log 2h on YLOG-352") into an
