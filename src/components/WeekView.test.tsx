      ...
      worklogs: [
        {
          ...
          issueUrl: "https://elevait.atlassian.net/browse/YLOG-397",
          issueType: { name: "Epic", hierarchyLevel: 1 },
...
describe("WeekView", () => {
  ...
  it("shows Jira link icons next to week ticket keys", () => {
    ...
    expect(markup.match(/href="https:\/\/elevait\.atlassian\.net\/browse\/YLOG-397"/g)).toHaveLength(1);
    expect(markup.match(/Open YLOG-397 in Jira/g)).toHaveLength(2);
    expect(markup).toContain("EPIC");
    expect(markup).toContain("Edit worklog for YLOG-397");
    expect(markup.match(/Edit worklog for YLOG-397/g)).toHaveLength(1);
